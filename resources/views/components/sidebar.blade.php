        ...
        <ul class="sidebar-menu">
            ...
            @if (Auth::user()->role == 1)
                <li class="{{ Request::is('jurusan') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ url('jurusan') }}"><i class="far fa-square"></i>
                        <span>Jurusan</span></a>
                </li>
                <li class="{{ Request::is('student') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ url('student') }}"><i class="far fa-square"></i>
                        <span>Pendaftaran</span></a>
                </li>
                <li class="{{ Request::is('user') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ url('user') }}"><i class="far fa-square"></i>
                ...
                <li class="nav-item dropdown {{ $type_menu === 'settings' ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ Request::is('aboute') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ url('aboute') }}">Tentang</a>
                        </li>
                        <li class="{{ Request::is('params') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ url('params') }}">Params</a>
                        </li>
                    </ul>
                </li>
            @endif
            ...
            <li class="nav-item dropdown {{ $type_menu === 'report' ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('report_student') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ url('report_student') }}">Laporan Pendaftaran Siswa</a>
                    </li>
