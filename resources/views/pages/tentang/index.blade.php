                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="card">
                            ...
                            <form id="formAboute" action="" method="method" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
...
@push('scripts')
    ...
    if (data.deskripsi) {
        $('.summernote-simple').summernote('code', data.deskripsi);
            ...
            method = 'POST';
            formUrl = "{{ route('aboute.update') }}";

        }



        $("#formAboute").submit(function(e) {
            ...
            Swal
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('aboute.destroy', ':id') }}".replace(':id', data.id),
                            type: "DELETE",
                            cache: false,
                            data: {
                                "_token": "{{ csrf_token() }}"
