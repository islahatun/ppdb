                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="card">
                            ...
                            <form id="formSlider" action="" method="method" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
            ...
            Swal
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('slider.destroy', ':id') }}".replace(':id', data.id),
                            type: "DELETE",
                            cache: false,
                            data: {
                                "_token": "{{ csrf_token() }}"
